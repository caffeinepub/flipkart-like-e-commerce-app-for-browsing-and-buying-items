...
export class Backend implements backendInterface {
    ...
    async mergeCart(arg0: Array<CartItem>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.mergeCart(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sortProductsByPrice(arg0: boolean): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.sortProductsByPrice(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
